...
const updateSettingsSchema = z.object({
    body: z.object({
        ...
        bkashNumber: z.string().trim().max(20).optional().or(z.literal('')),
        nagadNumber: z.string().trim().max(20).optional().or(z.literal('')),
        rocketNumber: z.string().trim().max(20).optional().or(z.literal('')),
